...
class TinySNS final {
 public:
  ...
  typedef WithAsyncMethod_Login<WithAsyncMethod_GetList<WithAsyncMethod_Follow<WithAsyncMethod_Unfollow<WithAsyncMethod_GetTimeline<WithAsyncMethod_PostTimeline<Service > > > > > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_Login<WithStreamedUnaryMethod_Follow<WithStreamedUnaryMethod_Unfollow<WithStreamedUnaryMethod_PostTimeline<Service > > > > StreamedUnaryService;
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_Login<WithSplitStreamingMethod_GetList<WithStreamedUnaryMethod_Follow<WithStreamedUnaryMethod_Unfollow<WithSplitStreamingMethod_GetTimeline<WithStreamedUnaryMethod_PostTimeline<Service > > > > > > StreamedService;
};
